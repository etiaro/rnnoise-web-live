...
const Module = (function () {
  ...
  return (
    function (Module, dataBinary) {
      Module = Module || {};

      // eslint-disable-next-line no-var
      null; var Module = typeof Module !== 'undefined' ? Module : {}; let readyPromiseResolve; let readyPromiseReject; Module['ready'] = new Promise(function (resolve, reject) {
      ...
      } let read_; let readAsync; let readBinary; let setWindowTitle; if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
      ...
      } let wasmMemory; const wasmTable = new WebAssembly.Table({ 'initial': 1, 'maximum': 1 + 0, 'element': 'anyfunc' }); let ABORT = false; let EXITSTATUS = 0; const WASM_PAGE_SIZE = 65536; function alignUp(x, multiple) {
        if (x % multiple > 0) {
      ...
      } const DYNAMIC_BASE = 5340496; const DYNAMICTOP_PTR = 97456; let INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 16777216; if (Module['wasmMemory']) {
        ...
        try {
          ...
          if (dataBinary) {
            return new Uint8Array(dataBinary);
          } else {
        ...
        requestedSize = requestedSize >>> 0; const oldSize = _emscripten_get_heap_size(); const PAGE_MULTIPLE = 65536; const maxHeapSize = 2147483648; if (requestedSize > maxHeapSize) {
          return false;
      ...
      } var asmLibraryArg = { 'a': _emscripten_memcpy_big, 'b': _emscripten_resize_heap, 'memory': wasmMemory, 'table': wasmTable }; const asm = createWasm(); var ___wasm_call_ctors = Module['___wasm_call_ctors'] = function () {
      ...
      }; let calledRun; dependenciesFulfilled = function runCaller() {
